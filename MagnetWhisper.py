...
class MagnetWhisper(WhisperForConditionalGeneration):
    ...
    def forward(
        ...
        outputs, boundary_loss = self.model(
            input_features,
...
class MagnetWhisperEncoder(WhisperEncoder):
    ...
    def forward(
        ...
        # inputs_embeds, boundary_loss = self.boundary_predictor(
        #     inputs_embeds)
        ...
        for idx, encoder_layer in enumerate(self.layers):
            ...
            if to_drop:
                ...
                if isinstance(predictor_module, BoundaryPredictor):
                    final_hs_for_layer, current_b_loss = predictor_module(layer_outputs[0])
